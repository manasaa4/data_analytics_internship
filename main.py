...
if st.session_state.current_page == "Login":
    ...
    if page_choice == "Sign Up":
        ...
        st.image("C:\gdp_productivity\img\signup.png", width=350)
        ...
        st.image("C:\gdp_productivity\img\login.png",  width=400,)
    ...
    if page == "Home":
        ...
        st.title("GDP and Productivity Visualisation App 📈")
        st.image("C:\gdp_productivity\img\Screenshot 2025-10-19 134910.png", width=700)
        ...
        print("\n")
        st.image("C:\gdp_productivity\img\chatbot.png", width=400)
        ...
        st.image("C:\gdp_productivity\img\Screenshot 2025-10-19 125522.png", width=400)

    elif page == "Logout":
        st.title("Logged Out Successfully 👋")
        st.markdown("You have been logged out. See you again soon!")
        st.image("C:\gdp_productivity\img\log out.png", width=350)        
        st.session_state.authenticated = False
        st.session_state.user_name = None
        st.session_state.current_page = "Login"